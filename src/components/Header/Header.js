            ...
            <Navbar sticky="top" className='d-flex justify-content-between align-items-center bg-black p-2'>
                ...
                <div>
                    ...
                    <Nav className="ms nav justify-content-center  p-3 m-3 ">
                        ...
                        <Nav.Link className='bg text-light fw-bold rounded ms-1' as={Link} to="/orderplace">Add New Order</Nav.Link>
                        ...
                        <Nav.Link className='bg text-light fw-bold border border-warning rounded ms-1' as={Link} to="/orderplace">Admin</Nav.Link>
                    </Nav>
